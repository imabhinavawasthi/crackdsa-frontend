      ...
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center gap-3 sm:justify-end">
          ...
          <div className="relative inline-flex items-center">
            <Calendar className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-3 lg:top-1/2 lg:translate-x-0 lg:-translate-y-1/2  text-gray-500 dark:text-gray-400 pointer-events-none z-10" size={20} />
            <input
              ref={datePickerRef}
