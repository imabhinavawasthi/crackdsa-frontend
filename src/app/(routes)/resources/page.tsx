...
import { FileText, Building2, Sparkles, BookOpen, ArrowRight } from "lucide-react";
...
export default function ResourcesPage() {
  ...
  const features = [
    {
      title: "Handbooks & Cheat Sheets",
      description: "Complete DS & Algorithm cheat sheets, visual code pattern review maps, and quick memory aids.",
      icon: FileText,
    ...
    {
      title: "Company Interview Decks",
      description: "Anonymized question trends, coding rounds breakdowns, and structural rubrics compiled directly from FAANG+ loops.",
      icon: Building2,
    ...
    },
    {
      ...
      description: "AI-powered workspace mock challenges that grade process steps, code styling, and execution efficiency in real-time.",
      icon: Sparkles,
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center max-w-3xl mb-16 space-y-6">
          ...
          <p className="text-base sm:text-lg md:text-xl font-medium text-gray-500 dark:text-gray-400 leading-relaxed max-w-2xl mx-auto">
            Interactive handbooks, reference manuals, real loop analyses, and custom templates - all designed to supercharge your prep path.
          </p>
        </motion.div>
